...
public class DataUtil
{
    ...
    */
    ...
    /**
     * <p>예외, 혹은 오류 객체의 내용을 텍스트로 반환합니다. 자바의 스택 추적 형식을 따릅니다. (참고 : DataUtil.traceException) </p>
     * 
     * @param t : 예외, 혹은 오류 객체
     * @return 텍스트 내용
     */
    ...
    /**
     * 예외 객체의 스택 트레이스 메시지를 문자열로 반환합니다. 자바의 기본 스택 트레이스 출력을 그대로 문자열로 반환합니다. (참고 : DataUtil.stackTrace)
     * 
     */
